...
@Repository
public class InMemoryPerformanceAirportRepository implements AirportRepository {

    private static final Map<String, Airport> AIRPORTS = Map.of(
            "LTFM", new Airport("ISTANBUL AIRPORT", "LTFM", 3000.0, new Coordinate(41.2622, 28.7278)),
            "LTDA", new Airport("HATAY AIRPORT", "LTDA", 3000.0, new Coordinate(36.362778, 36.282223)),
            "LTAI", new Airport("ANTALYA AIPORT", "LTAI", 3400.0, new Coordinate(36.8987, 30.8006))
    );
