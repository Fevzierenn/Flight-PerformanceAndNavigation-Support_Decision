package com.FlightPerformanceAndNavigationDecision.FPN_SupportPlatform.fuel.infrastructure.persistence;
...
@Repository
public class InMemoryFuelAircraftRepository implements AircraftRepository {
